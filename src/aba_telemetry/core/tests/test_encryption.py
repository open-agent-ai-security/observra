"""Tests for aba_telemetry.core.encryption module.
...
from aba_telemetry.core.encryption import (
    EncryptionProvider,
    decrypt_line,
    encrypt_line,
    get_encryption_key,
...
def _make_key(passphrase: str = "test-passphrase") -> bytes:
    ...
    from aba_telemetry.core.encryption import _derive_key_from_passphrase
