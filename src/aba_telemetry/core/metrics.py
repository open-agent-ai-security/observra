...
class MetricsRegistry:
    ...
    - Counters end in ``_total``   (e.g. aba_telemetry_events_dropped_total)
    - Gauges have no special suffix (e.g. aba_telemetry_queue_depth)
    - Latency histograms end in ``_seconds`` (e.g. aba_telemetry_write_latency_seconds)
    All names carry the ``aba_telemetry_`` prefix.
    """
