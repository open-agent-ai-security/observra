...
class BackgroundWorker:
    ...
    def _flush_batch(self) -> None:
        ...
        try:
            ...
            _registry.inc_counter("aba_telemetry_backend_write_success_total", len(batch_to_send))
            ...
            _registry.inc_counter("aba_telemetry_backend_write_failure_total", len(batch_to_send))
            logger.warning(
            ...
            try:
                ...
                if self._is_pooled:
                    ...
                    try:
                        ...
                        _registry.inc_counter("aba_telemetry_backend_write_success_total")
                        ...
                        _registry.inc_counter("aba_telemetry_backend_write_failure_total")
                        logger.warning(
