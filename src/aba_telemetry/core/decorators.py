...
Usage::
    ...
    @aba_telemetry.tool(name="lookup_user", capture_data=True)
...
def tool(
    ...
    *,
    ...
    Usage::
        ...
        # With options
        @aba_telemetry.tool(name="web_search", capture_data=True)
        def search_web(query: str) -> str: ...
...
def model_call(
    ...
    *,
    ...
    Usage::
        ...
        @aba_telemetry.model_call(model="claude-opus-4-6", prompt_arg="user_message")
    ...
    def decorator(fn: Callable) -> Callable:
        ...
        def sync_wrapper(*args: Any, **kwargs: Any) -> Any:
            ...
            from aba_telemetry.adapters.utils import estimate_tokens
...
def _lazy_imports():
    ...
    import aba_telemetry.log as _log
    from aba_telemetry.adapters.utils import safe_serialize
