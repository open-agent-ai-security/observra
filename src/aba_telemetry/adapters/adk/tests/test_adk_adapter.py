...
All imports use canonical paths:
  aba_telemetry.adapters.adk.plugin  (not compat shim)
  aba_telemetry.adapters.utils       (not direct ADK types)
"""
...
from aba_telemetry.adapters.utils import normalize_adk_tokens
