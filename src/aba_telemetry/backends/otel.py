...
Requires: pip install aba-telemetry[otel]
...
# Custom aba-telemetry namespace attributes
_AT_EVENT_ID = "aba_telemetry.event_id"
_AT_EVENT_TYPE = "aba_telemetry.event_type"
_AT_TRACE_ID = "aba_telemetry.trace_id"
_AT_SESSION_ID = "aba_telemetry.session_id"
_AT_FRAMEWORK = "aba_telemetry.framework"
_AT_COST_USD = "aba_telemetry.cost_usd"
_AT_HAS_INJECTION = "aba_telemetry.has_injection_patterns"
_AT_INJECTION_PATTERNS = "aba_telemetry.injection_patterns"
...
def _apply_gen_ai_attributes(span, event: TelemetryEvent) -> None:
    ...
    plus custom aba_telemetry.* namespace attributes.
    ...
    # Custom aba-telemetry namespace attributes (always set — never None from event)
...
class OTelExportBackend:
    ...
    Requires::
        ...
        pip install aba-telemetry[otel]
    """
    ...
    def __init__(
        ...
        service_name: str = "aba-telemetry",
        ...
        Args:
            ...
            service_name: OTel service.name resource attribute (default: "aba-telemetry").
        ...
        self._tracer = self._provider.get_tracer("aba-telemetry", "2.0.0")
