...
def _get_queue():
    """Return the module-level ``_queue_proxy`` from ``aba_telemetry``."""
    import aba_telemetry as _at
    return _at._queue_proxy


def _get_cost_calculator():
    """Return the module-level ``_cost_calculator`` from ``aba_telemetry``."""
    import aba_telemetry as _at
    return _at._cost_calculator


def _get_cost_threshold():
    """Return the module-level ``_cost_threshold`` from ``aba_telemetry``."""
    import aba_telemetry as _at
    return _at._cost_threshold


def _get_max_sequence_length() -> int:
    """Return the module-level ``_max_sequence_length`` from ``aba_telemetry``."""
    import aba_telemetry as _at
