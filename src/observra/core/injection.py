...
def get_injection_patterns() -> list[tuple[re.Pattern, InjectionMarker]]:
    ...
    return [
        ...
        (
            re.compile(
                r"\b(in a movie|fictional scenario|hypothetical|let\'s pretend|imagine you are)\b", re.IGNORECASE
            ),
        ...
        (
            re.compile(
                ...
                r"|print your system prompt|reveal your instructions)\b",
                re.IGNORECASE,
            ),
        ...
        (re.compile(r"\b([A-Za-z0-9+/]{20,}={0,2})\b"), InjectionMarker.BASE64_BLOB),
    ]
