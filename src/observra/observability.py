...
def get_metrics() -> dict:
    ...
    """
    hist = _registry.get_histogram("observra_write_latency_seconds")
    return {
        "drop_count": _registry.get_counter("observra_events_dropped_total"),
        "queue_depth": int(_registry.get_gauge("observra_queue_depth")),
        "write_latency_p50": hist.percentile(50),
        "write_latency_p99": hist.percentile(99),
        "write_latency_p999": hist.percentile(99.9),
        "redaction_applied_count": _registry.get_counter("observra_redaction_applied_total"),
        "backend_write_success": _registry.get_counter("observra_backend_write_success_total"),
        "backend_write_failure": _registry.get_counter("observra_backend_write_failure_total"),
